...
<html>
    <head>
        ...
        <title>Pagamento com Atraso</title>
        <style>
            .espacamento{
                padding: 50px;
            }
        ...
        <script>
            $(function () {
                $('#pagamentoAtraso').submit(function () {
                    $.ajax({
                        url: 'AlterarValorFilmeAtendente.jsp',
                        type: 'POST',
                        data: $('#pagamentoAtraso').serialize(),
                        success: function (data) {
                            alert("Pagamento Realizado em Atraso!");
                        }
                    });
                    return false;
                });
    ...
    <body>
        <%
            ...
            try {
                ...
                String dataHoje = "select getDate() as dia";
        ...
        <div class="espacamento" align='center'>
            <div class="card col-6">
                ...
                <form action="AlterarValorFilmeAtendente.jsp" id="pagamentoAtraso">
                    ...
                    <div class="form-group row mt-4">
                        <label for="staticEmail" class="col-sm-2 col-form-label ml-3" >Data de Entrega prevista:</label>
                        <div class="col-sm-9">
                            <input type="text" readonly="true" class="form-control" id="staticEmail" value="<%=rs.getString("dataEntrega")%>" required="true" name="nomeCliente">
                        </div>
                    </div>
                    <div class="form-group row mt-4">
                        <label for="staticEmail" class="col-sm-2 col-form-label ml-3">Informe os dias de atraso:</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="staticEmail"  required="true" name="qtdDiasAtraso">
                        </div>
                    </div>
                    <div class="form-group row mt-4">
