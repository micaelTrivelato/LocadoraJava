    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                String query = "SELECT * FROM cliente ORDER BY codCliente";
            ...
            <div class="row col-12">
                <%while (rs.next()) {%>
                    <div class='card col-4 mt-4'>
                        <div class='card-body'>
                            <h5 class="card-title"><p align="center">Nome do Cliente:  <%=rs.getString("nome")%></p></h5>
                            <h6 class="card-title"><p>RG do Cliente:  <%=rs.getString("rg")%> / CPF do Cliente:  <%=rs.getString("cpf")%></p></h6>
                            <h6 class="card-title"><p>E-mail do Cliente:  <%=rs.getString("email")%></p></h6>
                            <h6 class="card-title"><p>Endereço do Cliente:  <%=rs.getString("endereco")%></p></h6>
                            <h6 class="card-title"><p>Telefone:  <%=rs.getString("telefone")%> / Idade:  <%=rs.getString("idade")%> / Sexo:  <%=rs.getString("sexo")%></p></h6>
                            <a class="link" href="../Alterando/AlterarCliente.jsp?codCliente=<%=rs.getInt("codCliente")%> "><button class='btn btn-primary ml-4 mb-1 mt-2 col-sm-5 btnAcao' type='submit'> Editar </button></a>
                            <a class="link" href="../Apagando/ApagarCliente.jsp?codCliente=<%=rs.getInt("codCliente")%>"><button class='btn btn-primary ml-4 mb-1 mt-2 col-sm-5 btnAcao' type='submit'> Excluir </button></a>
                        </div>
                    </div>
                <%}%>             
            </div>
