            ...
            <div class="row col-12">
                ...
                <div class='card col-4 mt-4'>
                    <div class='card-body'>
                        ...
                        <div class="mt-4">
                            <a class="link" href="../Alterando/AlterarFilme.jsp?codFilme=<%=rs.getInt("codFilme")%> "><button class='btn btn-primary ml-4 mb-1 mt-2 col-sm-5 btnAcao' type='submit'> Editar </button></a>
                            <a class="link" href="../Apagando/ApagarFilme.jsp?codFilme=<%=rs.getInt("codFilme")%>"> <button class='btn btn-primary ml-4 mb-1 mt-2 col-sm-5 btnAcao' type='submit'>Excluir </button></a>
                        </div>
                    </div>
                </div>
                <%}%>             
