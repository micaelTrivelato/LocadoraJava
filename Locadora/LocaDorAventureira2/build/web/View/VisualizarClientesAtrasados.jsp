...
<html>
    <head>
        ...
        <title>Clientes que já atrasaram</title>
        <style>
            .espacamento{
                padding: 50px;
            }
    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                String query = "SELECT distinct nomeCliente, entregue FROM locacao ORDER BY nomeCliente";
        ...
        <section class="espacamento">
            <div class="row col-12">
                <%while (rs.next()) { 
                    if(rs.getString("entregue").equalsIgnoreCase("A")) {%>
