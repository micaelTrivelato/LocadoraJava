                ...
                <%while (rs.next()) { 
                    ...
                    <div class='card col-4 mt-4'>
                        <div class='card-body'>
                            ...
                            <a class="link" href="../Pagamento.jsp?codLocacao=<%=rs.getInt("codLocacao")%> "><button class='btn btn-primary ml-4 mb-1 mt-2 col-sm-5 btnAcao' type='submit'> Finalizar </button></a>
                            <a class="link" href="../PagamentoAtraso.jsp?codLocacao=<%=rs.getInt("codLocacao")%>"><button class='btn btn-primary ml-4 mb-1 mt-2 col-sm-5 btnAcao' type='submit'> Em Atraso </button></a>
                        </div>
                    </div>
                  <%}
                }%>
