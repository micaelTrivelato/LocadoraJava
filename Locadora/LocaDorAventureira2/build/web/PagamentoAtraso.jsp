...
<html>
    ...
    <body>
        <script>
            $(function () {
                $('#pagandoAtraso').submit(function () {
                    $.ajax({
                        url: 'conexaoBD/AlterarValorFilme.jsp',
                        type: 'POST',
                        data: $('#pagandoAtraso').serialize(),
                        success: function (data) {
                            alert("Pagamento Realizado com Atraso!");
                        }
                    });
                    return false;
                });
        ...
        <div class="espacamento" align='center'>
            <div class="card col-6">
                ...
                <form action="conexaoBD/AlterarValorFilme.jsp" id="pagandoAtraso">
