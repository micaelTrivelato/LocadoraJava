...
<html>
    ...
    <body>
        ...
        try{
            ...
            String query = "UPDATE filme SET nomeFilme = '" + request.getParameter("nomeFilme") 
                    + "', classificacaoIndicativa = '" + request.getParameter("classificacao")  
                    + "', sinopse = '" + request.getParameter("sinopse") 
                    + "', genero = '" + request.getParameter("genero") 
                    + "', qtdDisponivel = '" + request.getParameter("qtdDisponivel")
                    + "' WHERE codFilme = " + request.getParameter("codFilme");
            
            int ok = st.executeUpdate(query);
            
            if(ok > 0) 
                response.sendRedirect("../View/VisualizarFilmes.jsp");
            else 
