    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                String query = "update locacao set entregue = 'S' where codLocacao =" + request.getParameter("codLocacao");
                st.executeUpdate(query);
                                            
                response.sendRedirect("../View/VisualizarLocacoes.jsp");
